...
func (_Dosstaking *DosstakingTransactor) UpdateNodeStaking(opts *bind.TransactOpts, _nodeAddr common.Address, _newTokenAmount *big.Int, _newDropburnAmount *big.Int, _newCut *big.Int, _newDesc string) (*types.Transaction, error) {
	return _Dosstaking.contract.Transact(opts, "updateNodeStaking", _nodeAddr, _newTokenAmount, _newDropburnAmount, _newCut, _newDesc)
}

// UpdateNodeStaking is a paid mutator transaction binding the contract method 0x644fc9cf.
//
// Solidity: function updateNodeStaking(_nodeAddr address, _newTokenAmount uint256, _newDropburnAmount uint256, _newCut uint256, _newDesc string) returns()
func (_Dosstaking *DosstakingSession) UpdateNodeStaking(_nodeAddr common.Address, _newTokenAmount *big.Int, _newDropburnAmount *big.Int, _newCut *big.Int, _newDesc string) (*types.Transaction, error) {
	return _Dosstaking.Contract.UpdateNodeStaking(&_Dosstaking.TransactOpts, _nodeAddr, _newTokenAmount, _newDropburnAmount, _newCut, _newDesc)
}

// UpdateNodeStaking is a paid mutator transaction binding the contract method 0x644fc9cf.
//
// Solidity: function updateNodeStaking(_nodeAddr address, _newTokenAmount uint256, _newDropburnAmount uint256, _newCut uint256, _newDesc string) returns()
func (_Dosstaking *DosstakingTransactorSession) UpdateNodeStaking(_nodeAddr common.Address, _newTokenAmount *big.Int, _newDropburnAmount *big.Int, _newCut *big.Int, _newDesc string) (*types.Transaction, error) {
	return _Dosstaking.Contract.UpdateNodeStaking(&_Dosstaking.TransactOpts, _nodeAddr, _newTokenAmount, _newDropburnAmount, _newCut, _newDesc)
}
