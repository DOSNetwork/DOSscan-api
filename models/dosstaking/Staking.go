...
func (_Dosstaking *DosstakingCaller) RewardRateDelta(opts *bind.CallOpts) (*big.Int, error) {
	var (
		ret0 = new(*big.Int)
	)
	out := ret0
	err := _Dosstaking.contract.Call(opts, out, "rewardRateDelta")
	return *ret0, err
}
...
//
// Solidity: function rewardRateDelta() constant returns(uint256)
func (_Dosstaking *DosstakingSession) RewardRateDelta() (*big.Int, error) {
	return _Dosstaking.Contract.RewardRateDelta(&_Dosstaking.CallOpts)
}

// RewardRateDelta is a free data retrieval call binding the contract method 0x7c6250ff.
//
// Solidity: function rewardRateDelta() constant returns(uint256)
func (_Dosstaking *DosstakingCallerSession) RewardRateDelta() (*big.Int, error) {
	return _Dosstaking.Contract.RewardRateDelta(&_Dosstaking.CallOpts)
}
